...
const FILE_ICONS: Record<string, React.ReactNode> = {
  ...
  xlsx: <FileSpreadsheet className="h-5 w-5 text-orange-400" />,
  xls: <FileSpreadsheet className="h-5 w-5 text-orange-400" />,
  csv: <FileSpreadsheet className="h-5 w-5 text-orange-400" />,
            ...
            {bulkFaqs.length === 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
                {[
                  ...
                  { icon: <FileSpreadsheet className="h-4 w-4 text-orange-400" />, label: "Excel (.xlsx)" },
