                      ...
                      return (
                        <tr key={appt.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/10 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            ...
                            >
                              <option value="scheduled" className="bg-white dark:bg-slate-900 text-orange-500 font-semibold">Scheduled</option>
                              ...
                              {appt.status === "scheduled" && (
                                <>
                                  <Button
                                    ...
                                    className="h-8 w-8 text-slate-400 hover:text-orange-400 hover:bg-orange-500/10 rounded-lg"
                                  >
                          ...
                          return (
                            <div
                              ...
                              className={`text-[10px] font-medium truncate px-1.5 py-0.5 rounded border ${
                                appt.status === "scheduled"
                                  ? "bg-orange-500/5 text-orange-500 dark:text-orange-400 border-orange-500/15"
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-50 dark:bg-slate-950/40 p-4 rounded-2xl border border-slate-200 dark:border-slate-800/60 flex flex-col justify-center">
                  ...
                  <span className="text-sm font-semibold text-orange-500 dark:text-orange-400 mt-1">
                    {(() => {
