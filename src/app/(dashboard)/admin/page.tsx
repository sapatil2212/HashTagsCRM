...
const STATUS_META: Record<Status, { label: string; color: string; bg: string; icon: typeof CheckCircle }> = {
  active:    { label:"Active",    color:"text-orange-400", bg:"bg-orange-500/10 border-orange-500/20", icon:CheckCircle },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard label="Monthly Revenue" value={`$${totalMRR.toLocaleString()}`} sub="combined MRR"   icon={DollarSign}  accent="bg-orange-500/10 text-orange-400" />
