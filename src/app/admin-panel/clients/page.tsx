...
function Avatar({ name, email }: { name: string; email: string }) {
  ...
  return (
    <div className="w-9 h-9 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 text-sm font-bold shrink-0">
      {ch}
    </div>
  );
}
...
export default function AdminClientsPage() {
  ...
  const statusBadge = (c: Client) => {
    ...
    if (c.is_active)   return { label: "Active",    cls: "bg-orange-500/10 border-orange-500/20 text-orange-400" };
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
              <Users className="size-6 text-orange-400"/> Clients
            </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search name or email..."
              className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-slate-700 bg-slate-800 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-orange-500 transition-colors"/>
          </div>
          <select value={statusF} onChange={e=>setStatusF(e.target.value as FilterStatus)}
            className="px-3 py-2.5 rounded-xl border border-slate-700 bg-slate-800 text-sm text-white focus:outline-none focus:border-orange-500 transition-colors">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900">
          {loading ? (
            <div className="flex items-center justify-center py-20">
              <Loader2 className="size-8 text-orange-400 animate-spin"/>
            </div>
          ) : (
                    ...
                    {filtered.length === 0 ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            {c.wa_connected
                              ? <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full border bg-orange-500/10 border-orange-500/20 text-orange-400"><Wifi className="size-2.5"/>Connected</span>
                  ...
                  >
                    <button
                      ...
                      className={cn("flex items-center gap-2 w-full px-3 py-2.5 text-xs font-semibold transition-colors",
                        c.is_banned ? "text-orange-400 hover:bg-orange-500/10" : "text-amber-400 hover:bg-amber-500/10")}
                    >
              ...
              >
                ...
                <div className="p-5 space-y-5 flex-1">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 text-2xl font-bold">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                        ...
                        {detail.wa_connected && (
                          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border bg-orange-500/10 border-orange-500/20 text-orange-400">WA Connected</span>
                        )}
                        {detail.clinic_name && (
