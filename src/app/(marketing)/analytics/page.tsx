  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 space-y-20">
      ...
      <div className="rounded-2xl border border-[var(--m-border-primary)] bg-[var(--m-bg-card)] p-8 backdrop-blur-md relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-tr from-orange-950/5 via-teal-950/5 to-transparent pointer-events-none" />
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center relative z-10">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-1 text-xs font-bold text-orange-400 uppercase tracking-wide">
          ...
          <div className="lg:col-span-2 rounded-xl border border-[var(--m-border-primary)] bg-[var(--m-bg-secondary)]/30 p-6 h-[280px] flex flex-col justify-between relative overflow-hidden">
            <div className="flex justify-between items-center z-10">
              ...
              <span className="text-[10px] bg-orange-500/10 border border-orange-500/20 text-orange-400 font-bold px-2 py-0.5 rounded">
                +24% Year Over Year
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <SpotlightCard>
          <RefreshCw className="size-5 text-orange-400 mb-3 animate-spin" style={{ animationDuration: "12s" }} />
