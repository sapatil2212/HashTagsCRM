  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 space-y-20">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`text-[9px] font-bold px-2 py-0.5 rounded cursor-pointer ${
                    activeTab === "collision" ? "bg-orange-500/10 border border-orange-500/30 text-orange-400" : "text-[var(--m-text-muted)]"
                  }`}
                >
                  Collision Watch
                </button>
                <button
                  ...
                  className={`text-[9px] font-bold px-2 py-0.5 rounded cursor-pointer ${
                    activeTab === "notes" ? "bg-orange-500/10 border border-orange-500/30 text-orange-400" : "text-[var(--m-text-muted)]"
                  }`}
                >
                  Team Notes
                </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <SpotlightCard>
          <AlertTriangle className="size-5 text-orange-400 mb-3" />
        ...
        <SpotlightCard glowColor="rgba(255, 165, 0, 0.12)">
          <Inbox className="size-5 text-orange-400 mb-3" />
