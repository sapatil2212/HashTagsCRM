          ...
          <SpotlightCard key={story.company} interactive={true} className="p-8 flex flex-col justify-between min-h-[350px]">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs bg-orange-500/10 border border-orange-500/20 text-orange-400 font-bold px-2 py-0.5 rounded font-mono">
                  {story.metric}
                </span>
              </div>
            ...
            <div className="border-t border-[var(--m-border-primary)] pt-6 mt-6 relative pl-6">
              <Quote className="absolute left-0 top-6 size-4 text-orange-500/25" />
