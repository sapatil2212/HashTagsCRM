      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-[var(--m-border-primary)] pb-6">
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg border text-xs font-semibold transition-all cursor-pointer ${
                filter === tag.id
                  ? "bg-[var(--m-bg-secondary)] border-orange-500/30 text-orange-400 shadow-md"
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg pl-9 pr-4 py-2 text-xs text-[var(--m-text-secondary)] placeholder:text-[var(--m-text-muted)] focus:outline-none focus:border-orange-500/50"
          />
        </div>
      </div>
        ...
        {filtered.map((item) => (
          ...
          >
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t border-[var(--m-border-primary)] flex items-center justify-between text-[11px] font-semibold text-orange-500 hover:text-orange-400 cursor-pointer group/link">
