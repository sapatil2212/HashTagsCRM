  ...
  const compliance = [
    {
      ...
      icon: <CheckCircle className="size-4 text-orange-400" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FileText className="size-4 text-orange-400" />,
    },
  ];
    ...
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 space-y-20">
      ...
      <div className="rounded-2xl border border-[var(--m-border-primary)] bg-[var(--m-bg-card)] p-8 backdrop-blur-md relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto space-y-6 relative z-10 text-center">
          ...
          <div className="pt-2">
            <button className="bg-orange-500 hover:bg-orange-400 text-white text-xs font-bold px-6 py-3 rounded-xl transition-colors cursor-pointer">
