...
export default function FeaturesPage() {
  const capabilities = [
    ...
    },
    {
      ...
      icon: <HelpCircle className="size-5 text-orange-400" />
    },
    {
      name: "API & Webhooks",
    ...
    },
    {
      ...
      icon: <Smartphone className="size-5 text-orange-400" />
    },
    {
      name: "Projects & Tasks",
    ...
    },
    {
      ...
      icon: <Lock className="size-5 text-orange-400" />
    }
  ];
    ...
    <div className="w-full flex flex-col overflow-hidden">
      ...
      <section className="relative w-full py-20 px-4 md:px-6 max-w-6xl mx-auto space-y-6 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-orange-500/25 bg-[var(--m-badge-bg)] text-orange-500 text-[10px] font-bold uppercase tracking-wider"
        >
      ...
      <section className="py-24 px-4 md:px-6 border-t border-[var(--m-border-primary)] max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-start relative">
        <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-24">
          ...
          <div className="pt-2">
            <Link
              href="/pricing"
              className="inline-flex items-center gap-1.5 bg-orange-500 hover:bg-orange-400 text-white px-6 py-2.5 rounded-xl text-xs font-bold transition-all shadow-[0_0_12px_rgba(255,165,0,0.2)]"
            >
