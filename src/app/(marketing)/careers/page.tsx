  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 space-y-20">
      ...
      <div className="rounded-2xl border border-[var(--m-border-primary)] bg-[var(--m-bg-card)] p-8 backdrop-blur-md relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-950/5 to-amber-950/5 pointer-events-none" />
        <div className="max-w-2xl mx-auto text-center space-y-6 relative z-10">
          ...
          <form onSubmit={handleApply} className="flex gap-2 max-w-sm mx-auto">
            <input
              ...
              required
              className="flex-1 bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg px-3.5 py-2.5 text-xs text-[var(--m-text-secondary)] focus:outline-none focus:border-orange-500/50"
            />
            <button
              type="submit"
              className="bg-orange-500 hover:bg-orange-400 text-white text-xs font-bold px-4 py-2.5 rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer shrink-0"
            >
