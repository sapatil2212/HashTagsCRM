    ...
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 space-y-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-orange-500/25 bg-orange-950/20 text-orange-400 text-[10px] font-bold uppercase tracking-wider">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-orange-500/5 blur-[95px] pointer-events-none" />
          <div className="rounded-2xl border border-[var(--m-border-primary)] bg-[var(--m-bg-glass)] p-6 backdrop-blur flex flex-col justify-between h-[360px] shadow-2xl relative z-10">
            ...
            <div className="flex items-center justify-between border-b border-[var(--m-border-primary)] pb-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded bg-orange-500/10 flex items-center justify-center text-orange-400">
              ...
              <span className="text-[8px] bg-orange-500/10 border border-orange-500/20 text-orange-400 rounded px-1.5 font-bold">META APPROVED</span>
            </div>
            ...
            <div className="flex-1 space-y-4 pt-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg px-3 py-1.5 text-xs text-[var(--m-text-primary)] focus:outline-none focus:border-orange-500/55"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg px-3 py-1.5 text-xs text-[var(--m-text-primary)] focus:outline-none focus:border-orange-500/55 resize-none font-sans"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between border-t border-[var(--m-border-primary)] pt-4 mt-2">
              ...
              <button className="bg-orange-500 hover:bg-orange-400 text-white text-xs font-bold px-4 py-2 rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <SpotlightCard>
          <CheckCheck className="size-5 text-orange-400 mb-3" />
        ...
        <SpotlightCard glowColor="rgba(255, 165, 0, 0.12)">
          <Sparkles className="size-5 text-orange-400 mb-3" />
