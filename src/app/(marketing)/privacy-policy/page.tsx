    ...
    <div className="w-full max-w-4xl mx-auto px-4 md:px-6 py-20 space-y-10">
      ...
      <div className="space-y-8 text-xs sm:text-sm text-[var(--m-text-secondary)] leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            You may request complete and permanent deletion of your profile, CRM contact records, and metadata history at any time. Refer to our dynamic <a href="/data-deletion" className="text-orange-400 hover:underline">Data Deletion Instructions</a> page or email our support desk. Upon validation, deletion is processed within 7 business days.
          </p>
        </section>
