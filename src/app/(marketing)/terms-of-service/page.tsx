    ...
    <div className="w-full max-w-4xl mx-auto px-4 md:px-6 py-20 space-y-10">
      ...
      <div className="space-y-8 text-xs sm:text-sm text-[var(--m-text-secondary)] leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            THE PLATFORM IS PROVIDED &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; WITHOUT WARRANTY OF ANY KIND. HASHTAGS CRM DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            These Terms are governed by applicable laws. Any disputes shall be subject to exclusive jurisdiction.
          </p>
        </section>
        ...
        <section className="space-y-3 text-center pt-8 border-t border-[var(--m-border-primary)]/50">
          ...
          <p>
            For questions or concerns about these Terms, please contact us at <a href="mailto:admin@hashtagscrm.com" className="text-orange-400 hover:underline">admin@hashtagscrm.com</a>.
          </p>
        </section>
      </div>
    </div>
