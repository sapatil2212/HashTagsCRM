    ...
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 border-t border-[var(--m-border-primary)] pt-6 mt-6">
          ...
          <div className="flex items-center gap-3.5 text-xs text-[var(--m-text-tertiary)]">
            <Mail className="size-4 text-orange-400 shrink-0" />
            <div>
              <span className="block font-bold text-[var(--m-text-primary)]">Email Support</span>
              <a href="mailto:admin@hashtagscrm.com" className="hover:text-orange-400 transition-colors">
          ...
          <div className="flex items-center gap-3.5 text-xs text-[var(--m-text-tertiary)]">
            ...
            <div>
              ...
              <a href="tel:+923161122339" className="hover:text-teal-400 transition-colors">
                +92 316 1122339
              </a>
            </div>
          </div>
        ...
        {submitted ? (
          <Card className="border-[var(--m-border-primary)] bg-[var(--m-bg-glass)] p-6 backdrop-blur text-center relative z-10 shadow-2xl">
            <CardContent className="pt-6 space-y-4">
              <div className="w-10 h-10 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 mx-auto">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    required
                    className="h-10 border-[var(--m-input-border)] bg-[var(--m-input-bg)] text-xs text-[var(--m-text-primary)] focus-visible:border-orange-500 focus-visible:ring-orange-500/20"
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg p-3 text-xs text-[var(--m-text-primary)] placeholder:text-slate-655 focus:outline-none focus:border-orange-500/50 resize-none font-sans"
                  />
                </div>

                <Button
                  type="submit"
                  className="mt-2 h-10 w-full bg-orange-500 text-white hover:bg-orange-400 font-bold text-xs shadow-[0_0_12px_rgba(255,165,0,0.2)]"
                >
                  Submit Inquiry
                </Button>
              </form>
