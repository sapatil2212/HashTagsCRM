      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3.5 border-t border-[var(--m-border-primary)] pt-6 mt-6">
          ...
          <div className="flex items-center gap-3.5 text-xs text-[var(--m-text-tertiary)]">
            ...
            <span>Phone: +92 316 1122339</span>
          </div>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full bg-[var(--m-input-bg)] border border-[var(--m-input-border)] rounded-lg p-3 text-xs text-[var(--m-text-primary)] placeholder:text-slate-650 focus:outline-none focus:border-orange-500/50 resize-none font-sans"
                  />
                </div>
