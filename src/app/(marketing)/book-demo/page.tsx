        ...
        {success ? (
          ...
          <div className="rounded-2xl border border-[var(--m-border-primary)] bg-[var(--m-bg-glass)] p-6 backdrop-blur relative z-10 shadow-2xl space-y-6">
            <div className="flex items-center gap-2 mb-2">
              <Calendar className="size-4.5 text-orange-400" />
                  ...
                  <button
                    ...
                    className={`px-3 py-2.5 rounded-lg border text-xs font-semibold transition-all cursor-pointer ${
                      selectedDate === d.label
                        ? "bg-[var(--m-bg-secondary)] border-orange-500/40 text-orange-400"
            ...
            {selectedDate && selectedTime && (
              <button
                ...
                className="w-full h-10 bg-orange-500 text-white font-bold text-xs rounded-xl flex items-center justify-center transition-colors hover:bg-orange-400 cursor-pointer shadow-[0_0_12px_rgba(255,165,0,0.2)]"
              >
                Confirm Appointment
              </button>
            )}
