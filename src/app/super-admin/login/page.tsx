        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="relative mb-5">
              ...
              <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-orange-500 border-2 border-white flex items-center justify-center shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@hashtagscrm.com"
