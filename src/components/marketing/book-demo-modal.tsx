...
export function BookDemoModal({ open, onClose }: BookDemoModalProps) {
  ...
  const inputCls = cn(
    ...
    "bg-m-bg-primary border border-m-border-primary text-m-text-primary placeholder:text-m-text-muted/50 focus:border-orange-500 focus:ring-orange-500/20"
  );
              ...
              {success ? (
                ...
                <div className="px-6 py-12 flex flex-col items-center text-center gap-4 bg-transparent">
                  <div className="w-14 h-14 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center">
                    <CheckCircle className="size-7 text-orange-500" />
                  </div>
                  <h3 className="text-lg font-bold text-m-text-heading">
                    You're booked!
                  </h3>
                  <p className="text-xs leading-relaxed max-w-sm text-m-text-secondary">
                    A confirmation email has been sent to <span className="font-semibold text-m-text-primary">{email}</span>. We'll meet on <span className="text-orange-500 font-semibold">{selectedDate}</span> at <span className="text-orange-500 font-semibold">{selectedTime}</span> via Google Meet.
                  </p>
                  <button
                    onClick={handleClose}
                    className="mt-2 px-6 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-400 text-white text-xs font-bold transition-colors cursor-pointer shadow-[0_2px_12px_rgba(255,165,0,0.3)]"
                  >
                    Done
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 py-4 border-t border-m-border-primary bg-m-bg-primary/20">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-400 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-bold transition-all shadow-[0_2px_12px_rgba(255,165,0,0.3)] flex items-center justify-center gap-1.5 cursor-pointer"
                    >
