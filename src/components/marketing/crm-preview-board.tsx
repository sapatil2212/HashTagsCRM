...
export function CRMPreviewBoard() {
  const [leads, setLeads] = useState<CRMLead[]>([
    { id: "1", name: "David Kim", company: "Zeta Scale", value: 1200, score: 94, avatarColor: "bg-orange-500", stage: 0 },
    { id: "2", name: "Elena Rostova", company: "Vostok D2C", value: 850, score: 88, avatarColor: "bg-amber-500", stage: 1 },
    { id: "3", name: "Marcus Brody", company: "Indy Tech", value: 2400, score: 99, avatarColor: "bg-orange-600", stage: 2 },
    { id: "4", name: "Sophia Martinez", company: "Alt Co", value: 3100, score: 97, avatarColor: "bg-amber-600", stage: 3 },
  ]);
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 border-b border-[var(--m-border-glass)] pb-4">
        <div>
          <h4 className="text-sm font-semibold text-[var(--m-text-primary)] flex items-center gap-2">
            Active WhatsApp Sales Pipeline <TrendingUp className="size-4 text-orange-400" />
          </h4>
        ...
        <div className="flex gap-4">
          ...
          <div className="bg-orange-950/30 border border-orange-800/40 px-3 py-1.5 rounded-lg flex items-center gap-2">
            <span className="text-[10px] uppercase text-orange-400 font-medium">AI Qualified</span>
            <span className="text-xs font-bold text-orange-400">92%</span>
          </div>
        </div>
      </div>
                  ...
                  {stageLeads.map((lead) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-2.5 pt-2 border-t border-[var(--m-border-primary)]">
                        ...
                        <span className="text-[9px] bg-orange-500/10 border border-orange-500/20 text-orange-400 rounded px-1.5 py-0.5 flex items-center gap-0.5 font-bold font-mono">
                          <Sparkles className="size-2 text-orange-400 animate-pulse" /> {lead.score}%
                        </span>
                      </div>
                    </motion.div>
                  ))}
