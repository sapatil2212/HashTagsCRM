      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-[var(--m-border-primary)] pb-4">
            ...
            <div className="flex gap-2">
              ...
              <span className="w-2.5 h-2.5 rounded-full bg-[var(--m-bg-tertiary)]" />
              <span className="w-2.5 h-2.5 rounded-full bg-orange-500/30" />
            </div>
          </div>
            ...
            <div className="col-span-2 space-y-4">
                ...
                <svg className="absolute bottom-0 left-0 right-0 w-full h-[90px] pointer-events-none" viewBox="0 0 400 100" preserveAspectRatio="none">
                  <defs>
                    <linearGradient id="chart-glow" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="rgb(255, 165, 0)" stopOpacity="0.30" />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-xl border border-[var(--m-border-primary)] bg-[var(--m-bg-card)] p-3 flex flex-col justify-between">
                  ...
                  <span className="text-sm font-bold text-orange-400 mt-2">91.4% Avg</span>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-[var(--m-border-primary)] pb-2.5 mb-2.5">
            <div className="flex items-center gap-2">
              <Inbox className="size-3.5 text-orange-400" />
              <span className="text-xs font-semibold text-[var(--m-text-secondary)]">Shared Inbox</span>
            </div>
            <span className="text-[8px] bg-orange-500/10 border border-orange-500/20 text-orange-400 rounded px-1.5 font-bold">LIVE</span>
          </div>
          ...
          <div className="flex-1 space-y-2.5">
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-[var(--m-bg-card)] border border-[var(--m-border-glass)]">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-full bg-orange-500/20 text-orange-400 flex items-center justify-center font-bold text-[10px]">JD</div>
                <div>
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-[var(--m-bg-card)] border border-[var(--m-border-glass)] opacity-70">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-full bg-orange-500/20 text-orange-400 flex items-center justify-center font-bold text-[10px]">RT</div>
                <div>
        ...
        <motion.div
          ...
          className="absolute w-[310px] h-[220px] rounded-xl border border-orange-500/30 bg-[var(--m-bg-primary)] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col justify-between"
        >
          ...
          <div className="flex-1 space-y-2.5 pt-1">
            <div className="flex items-center justify-between text-[10px] bg-[var(--m-bg-secondary)] border border-[var(--m-border-primary)] p-2 rounded-lg">
              ...
              <span className="bg-orange-500/10 text-orange-400 font-bold border border-orange-500/20 px-1.5 py-0.5 rounded text-[8px]">
                "Intent: Enterprise"
              </span>
            </div>
            ...
            <div className="flex items-center justify-between text-[10px] bg-orange-950/20 border border-orange-800/40 p-2 rounded-lg">
