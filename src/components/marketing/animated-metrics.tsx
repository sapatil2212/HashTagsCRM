  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto py-10">
      ...
      >
        ...
        <div className="absolute -bottom-8 -right-8 w-24 h-24 rounded-full bg-orange-500/10 blur-2xl" />
      </motion.div>
      ...
      >
        ...
        <div className="absolute -bottom-8 -right-8 w-24 h-24 rounded-full bg-amber-500/10 blur-2xl" />
      </motion.div>
