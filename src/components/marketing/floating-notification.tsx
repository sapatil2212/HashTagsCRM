...
export function FloatingNotification() {
  const events: NotificationEvent[] = [
    ...
    },
    {
      ...
      icon: <UserCheck className="size-4 text-amber-400" />,
    },
    {
      id: "3",
      type: "campaign",
      ...
      icon: <MessageSquare className="size-4 text-orange-400" />,
    },
  ];
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h5 className="text-[11px] font-semibold text-[var(--m-text-primary)] flex items-center gap-1">
              {current.title}{" "}
              {current.type === "ai" && <Sparkles className="size-3 text-orange-400" />}
            </h5>
